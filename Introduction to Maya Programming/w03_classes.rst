...
В данном примере класс B унаследовал все функции класса A. Для наследования мы всегда должны указывать класс, который наследуем, в аргументах наследующего класса.
