...
Процедура, как и любая MEL команда, может возвращать результаты. Однако при этом мы должну в объявлении процедуры указать тип возвращаемого значения. Например, если мы производим всякие расчеты, и нам нужно выдать названия геометрического объекта и присвоить его переменной, делается это следующим образом.
