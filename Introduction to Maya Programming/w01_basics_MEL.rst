...
.. code-block:: cpp
    ...
    ||  ИЛИ if($a == 16 || $a > 20) //Условие считается выполненным в том случае, если одно из двух сравнений выдало положительный результат

    &&	и	if($a == 16 && $a < 20) //Условие считается выполненным, если оба сравнения дали положительный результат

    !	не	if($a != 20) //Условие выполнено если $a не равно 20
