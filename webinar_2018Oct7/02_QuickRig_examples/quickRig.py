...
class QuickRig(QtWidgets.QDialog):

    def __init__(self):
        
        QtWidgets.QDialog.__init__(self, parent = None)

        self.setObjectName("quickRig")
        self.setWindowTitle("Quick Rig")
        ...
        self.checkbox_layer = QtWidgets.QCheckBox("Display Layer")
        self.checkbox_scene = QtWidgets.QCheckBox("Scene Hierarchy")
        self.optionsLayout.addWidget(self.checkbox_layer)
        self.optionsLayout.addWidget(self.checkbox_scene)

        self.buttonsLayout = QtWidgets.QHBoxLayout()
        self.buttonOK = QtWidgets.QPushButton("Create")
        self.buttonOK.clicked.connect(self.doRig)
    ...
    def doRig(self):
        sceneValue = self.checkbox_scene.isChecked()
        layerValue = self.checkbox_layer.isChecked()

        createRig(optLayer = layerValue, optScene = sceneValue)
...
def main():
    ...
    if cmds.window("quickRig",q=True,exists=True):
        cmds.deleteUI("quickRig")
